...
namespace Myado.UI.Controls.Core
{
    public partial class MyLoading : UserControl
    {
        ...
        public static readonly DependencyProperty IsRunningProperty = DependencyProperty.Register("IsRunning", typeof(bool), typeof(MyLoading), new PropertyMetadata(false, OnIsRunningChanged));

        private static void OnIsRunningChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var load = d as MyLoading;
